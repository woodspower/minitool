...
def dict_to_tf_example(data,
  ...
  """
  #leo: VOTT record a wrong data['folder'] inside annotations xml file, temp ignore it.
  #leo: VOTT record data['filename'] without .jpg, temp add it
  ...
  for obj in data['object']:
    #leo: VOTT does not support difficult key
    if 'difficult' not in obj.keys():
      difficult = False
    else:
    ...
    #leo: VOTT does not support truncated key
